...
for uhidPatient in deathCaseUHID:
    ...
    #Intake Output
    cur9= con.cursor()
    cur9.execute("SELECT t1.uhid,t1.abdomen_girth,t1.urine,t1.stool,t1.stool_passed, t1.entry_timestamp FROM "+schemaName+".nursing_intake_output AS t1 where t1.uhid = '"+uhidPatient+"'")
    ...
    #Blood Gas
    cur1 = con.cursor()
    cur1.execute("SELECT uhid,creationtime,modificationtime,ph,entrydate FROM "+schemaName+".nursing_bloodgas where uhid ='"+ uhidPatient+"'")
    cols1 = list(map(lambda x: x[0],cur1.description))
    ...
    #Vitals
    cur3 = con.cursor()
    cur3.execute("SELECT t1.uhid,t1.entrydate,t1.rbs,t1.skintemp,t1.centraltemp  FROM "+schemaName+".nursing_vitalparameters AS t1 where t1.uhid = '"+uhidPatient+"'")
    ...
    #Anthropometry
    cur2 = con.cursor()
    cur2.execute("SELECT t1.uhid,t1.visitdate,t1.visittime,t1.currentdateweight, t1.currentdateheight  FROM "+schemaName+".baby_visit AS t1 where t1.uhid = '"+uhidPatient+"'")
    ...
    #Medications
    cur7= con.cursor()
    cur7.execute("SELECT t1.uhid,t1.startdate,t1.medicineorderdate,t1.medicinename,t1.medicationtype,t2.typevalue FROM "+schemaName+".baby_prescription AS t1 LEFT JOIN "+schemaName+".ref_medtype AS t2 ON t1.medicationtype = t2.typeid WHERE (t1.medicationtype = 'TYPE0001' OR t1.medicationtype = 'TYPE0009' OR t1.medicationtype = 'TYPE0004') and (t1.uhid ='"+uhidPatient+"')")
    ...
    #Nutrition
    cur8= con.cursor()
    cur8.execute("SELECT t1.uhid,t1.entrydatetime,t1.totalparenteralvolume,t1.total_intake FROM "+schemaName+".babyfeed_detail AS t1 where t1.uhid = '"+uhidPatient+"'")
